<template>
  <v-app light>
    <v-content>
      <section>
        <v-parallax id="bg2" :src="imageLink.sub_main">
          <v-layout column align-center justify-center class="white--text">
            ...
            <div
              class="white--text subheading px-10 text-xs-center text-lg-center d-none d-sm-flex"
              style="font-weight: 900; text-shadow: 2px 2px #000000"
            >
              በፍቃደኝነት ላይ የተመሰረተ የስጦታ ሲስተም ስልጠና ማዕከል ኃ. የተ.ግ .ማ በአዉታረ መረብ እኛዉ በኛዉ ወደኛዉ የስጦታ
              መቀባበያ ብልሃት በትክክለኛ ጥረት እና መንገድ የሰዎችን ህይወት በስልጠና፣ በአስተሳሰብ፣ በገንዘብ እና በሁለንተናዊ
              ስብዕና የመቀየሪያ ስልት ነው።
            </div>
            <div
              class="white--text subheading px-10 text-xs-center text-lg-center d-flex d-sm-none"
              style="font-weight: 900; text-shadow: 2px 2px #000000; font-size: 12px"
            >
              በፍቃደኝነት ላይ የተመሰረተ የስጦታ ሲስተም ስልጠና ማዕከል ኃ. የተ.ግ .ማ በአዉታረ መረብ እኛዉ በኛዉ ወደኛዉ የስጦታ
              መቀባበያ ብልሃት በትክክለኛ ጥረት እና መንገድ የሰዎችን ህይወት በስልጠና፣ በአስተሳሰብ፣ በገንዘብ እና በሁለንተናዊ
              ስብዕና የመቀየሪያ ስልት ነው።
            </div>
            <v-btn class="primary" dark to="/login"> Get Started </v-btn>
          </v-layout>
        </v-parallax>
      </section>
      ...
      <!-- <section>
                            ...
                            <v-layout row wrap align-center>
                                <v-flex xs12 md4>
                                    <v-card class="elevation-0 transparent">
                                        ...
                                        <v-card-text>
                                            Show your stuff to the whole community of Endorfine not only to your mum or
                                            your friends. We love making good content viral. In this moment Endorfine is
                                            used by artists who are not famous but that want to share their works to the
                                            world. Unfortunately with other social networks this is hard, slow and
                                            sometime expensive.
                                        </v-card-text>
                                    </v-card>
                                </v-flex>
                                <v-flex xs12 md4>
                                    <v-card class="elevation-0 transparent">
                                        ...
                                        <v-card-text>
                                            ...
                                            feedback from real users in minutes. And if your stuff is appreciated you
                                            won't only get positive feedback but also lovely and sincere fans <3
                                                </v-card-text> </v-card> </v-flex> <v-flex xs12 md4>
                                                <v-card class="elevation-0 transparent">
                                                    <v-card-text class="text-xs-center">
                                                        <v-icon x-large class="blue--text text--lighten-2">share
                                                        </v-icon>
                                                    </v-card-text>
                                                    <v-card-title primary-title class="layout justify-center">
                                                        <div class="headline text-xs-center">Create new connections
                                                        </div>
                                                    </v-card-title>
                                                    <v-card-text>
                                                        Imagine if you can directly speak with the world's population.
                                                        Don't you think it would be easier to find nice people to
                                                        interact with? Endorfine is both local and global and help you
                                                        to connect without limitations with people from your city, your
                                                        state and your universe!
                                                    </v-card-text>
                                                </v-card>
                                </v-flex>
                            </v-layout>
            ...
            <section>
                <v-parallax :src="imageLink.main" height="380">
                    <v-layout column align-center justify-center>
                        <div class="headline white--text mb-3 text-xs-center">Endorfine is a social network that allows
                            everyone to reach a huge audience with a tap </div>
                        <em>With the power of Endorfine you don't need to be famous or post pics of cute cats in order
                            to get visibility</em>
                ...
                <v-container grid-list-md>
                    ...
                    <v-layout row wrap>
                        <v-flex xs12 text-xs-center class="mt-5">
                            ...
                            <br>
                            <div>We are lunching the beta in a few time. If you want to be one of the first Endorfine
                                users we will email you as soon as we're ready. In the beginning only few people will
                                test before the launch. Let us know how Endorfine will help you!</div>
                        </v-flex>
            ...
            <section>
                <v-parallax :src="imageLink.social_cover" height="380">
                    <v-layout column align-center justify-center>
                        <div class="headline white--text mb-3 text-xs-center">We are dropping cool news and
                            opportunities on socials</div>
                    </v-layout>
                    ...
                    <v-layout row wrap justify-center class="my-5">
                        <v-flex xs12 sm4>
                            <v-card class="elevation-0 transparent">
                                ...
                                <v-card-text>
                                    We are not a company. We hate companies. Just imagine us like the guys from the
